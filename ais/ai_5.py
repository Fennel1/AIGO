...
def evaluation(is_ai, listAI, listHuman):
    ...
    for pt in enemy_list:
        m = pt[0]
        n = pt[1]
        enemy_score += cal_score(m, n, 0, 1, my_list, enemy_list, score_all_arr_enemy,10)
        enemy_score += cal_score(m, n, 1, 0, my_list, enemy_list, score_all_arr_enemy,10)
        enemy_score += cal_score(m, n, 1, 1, my_list, enemy_list, score_all_arr_enemy,10)
        enemy_score += cal_score(m, n, -1, 1, my_list, enemy_list, score_all_arr_enemy,10)
...
def cal_score(m, n, x_decrict, y_derice, enemy_list, my_list, score_all_arr,num):
    """
    每个方向上的分值计算
    :param m:
    :param n:
    ...
    return add_score + max_score_shape[0] + num
