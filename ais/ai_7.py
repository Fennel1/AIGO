...
def evaluation(is_ai, listAI, listHuman):
    ...
    for pt in enemy_list:
        m = pt[0]
        n = pt[1]
        enemy_score += cal_score(m, n, 0, 1, my_list, enemy_list, score_all_arr_enemy,5)
        enemy_score += cal_score(m, n, 1, 0, my_list, enemy_list, score_all_arr_enemy,5)
        enemy_score += cal_score(m, n, 1, 1, my_list, enemy_list, score_all_arr_enemy,5)
        enemy_score += cal_score(m, n, -1, 1, my_list, enemy_list, score_all_arr_enemy,5)
